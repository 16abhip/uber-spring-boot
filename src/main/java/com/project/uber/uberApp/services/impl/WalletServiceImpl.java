...
//        walletTransactionService.createNewWalletTransaction(walletTransaction);
    ...
    public Wallet findWalletById(Long walletId) {
        return walletRepository.findById(walletId).orElseThrow(() -> new ResourceNotFoundException("Wallet not found with walletId: "+ walletId));
    }
    ...
    public Wallet findByUser(User user) {
        return walletRepository.findByUser(user).orElseThrow(() -> new ResourceNotFoundException("Wallet not found for user with userId: "+ user.getId()));
    }
