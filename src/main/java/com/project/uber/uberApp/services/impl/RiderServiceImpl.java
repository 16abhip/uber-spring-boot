...
public class RiderServiceImpl implements RiderService {
    ...
    public RideRequestDto requestRide(RideRequestDto rideRequestDto) {
        ...
        List<Driver> drivers = rideStrategyManager.driverMatching(rider.getRating()).findMatchingDriver(rideRequest);
    ...
    public RideDto cancelRide(Long rideId) {
        ...
        if(!rider.equals(ride.getRider())){
            throw new RuntimeException("Rider does not own this ride, Ride id: "+rideId);
        }
    ...
    public DriverDto rateDriver(Long rideId, Integer rating) {
        ...
        if(!ride.getRideStatus().equals(RideStatus.ENDED)){
            throw new RuntimeException("Ride status is not Ended hence cannot rate the driver, status: "+ride.getRideStatus());
        }
